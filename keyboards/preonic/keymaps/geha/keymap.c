 ...
 * `-----------------------------------------------------------------------------------'
 */
[_COLEMAK_MDH] = LAYOUT_preonic_grid( \
  KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSLS, \
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_LALT, _______, _______  \
),
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  _______, KC_AE,   KC_OE,   KC_UE,   KC_SS,   _______, KC_UNDS, KC_MINS, KC_LCBR, KC_RCBR, ARROW,   KC_DEL , \
  _______, KC_DEGR, _______, _______, _______, _______, KC_PLUS, KC_EQL , KC_LBRC, KC_RBRC, KC_TILD, _______, \
 ...
 * |      |      |      |      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      | Ms 2 | Ms ↑ | Ms 1 | Ms 3 |      |      |      |Pg Up |  Up  |Pg Dn | Bksp |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      | Ms ← | Ms ↓ | Ms → | Msw↑ |      |      |  Ins | Left | Down |Right | Del  |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      |      | Ms 3 | Msw↓ |      |      |      | Home |  End | Menu |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_MOVEMENT] = LAYOUT_preonic_grid( \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  _______, KC_BTN2, KC_MS_U, KC_BTN1, KC_BTN3, _______, _______, _______, KC_PGUP, KC_UP,   KC_PGDN, KC_BSPC, \
  _______, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_U, _______, _______, KC_INS,  KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL , \
  _______, _______, _______, KC_BTN3, KC_WH_D, _______, _______, _______, KC_HOME, KC_END,  KC_APP,  _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______  \
),
