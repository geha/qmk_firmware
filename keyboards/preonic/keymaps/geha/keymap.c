...
[_NUMPAD] = {
  ...
  {_______, KC_MPRV, KC_MPLY, KC_MNXT, KC_COLN, _______, KC_ESC,  KC_7,    KC_8,    KC_9,    KC_MINS, KC_SLSH},
  {_______, KC_VOLD, KC_MUTE, KC_VOLU, KC_DOT,  KC_CALC, _______, KC_4,    KC_5,    KC_6,    KC_PLUS, KC_ASTR},
