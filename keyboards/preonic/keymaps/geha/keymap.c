 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  | Alt  | Media|Lower |    Space    |Raise | Move |  Alt |  GUI | Ctrl |
 * `-----------------------------------------------------------------------------------'
 */
[_COLEMAK_MDH] = {
  ...
  {KC_LCTL, KC_LGUI, KC_LALT, MEDIA,   LOWER,   KC_SPC,  KC_SPC,  RAISE,   MOVE,    KC_RALT, KC_RGUI, KC_RCTL}
},
...
[_ADJUST] = {
  ...
  {_______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  CLMK_DH, _______, _______, _______},
