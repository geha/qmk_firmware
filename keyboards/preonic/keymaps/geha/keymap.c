...
[_QWERTY] = {
  ...
  {KC_LCTL, KC_LGUI, KC_LALT, MOVE,    LOWER,   KC_SPC,  KC_SPC,  RAISE,   MOVE,    KC_RALT, KC_RGUI, KC_RCTL}
},
...
[_COLEMAK_MDH] = {
  ...
  {NUMPAD,  KC_A,    KC_R,    KC_S,    KC_T,    KC_G,    KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT},
...
[_LOWER] = {
  ...
  {LCTL(KC_TAB), KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______, _______, KC_AMPR, KC_ASTR, KC_TILD, _______, KC_DEL },
...
[_RAISE] = {
  ...
  {_______, KC_EURO, _______, _______, _______, _______, _______, _______, KC_LPRN, KC_RPRN, _______, KC_DEL },
  {_______, KC_AE,   KC_OE,   KC_UE,   KC_SS,   _______, KC_UNDS, KC_MINS, KC_LCBR, KC_RCBR, _______, _______},
  {_______, _______, _______, _______, _______, _______, KC_PLUS, KC_EQL , KC_LBRC, KC_RBRC, _______, _______},
 ...
 * |      |      |      |      |      |      |      |      |      |      |      | Bksp |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |Pg Up |  Up  |Pg Dn |      |      |      |      |Pg Up |  Up  |Pg Dn | Del  |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      | Left | Down |Right |      |      |      |  Ins | Left | Down |Right |Shift |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      |      |      |      |      |      | Home |  End |      | Menu |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      |      |      |      |      |
...
[_MOVEMENT] = {
  ...
  {_______, KC_PGUP, KC_UP,   KC_PGDN, _______, _______, _______, _______, KC_PGUP, KC_UP,   KC_PGDN, KC_DEL },
  {_______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, KC_INS,  KC_LEFT, KC_DOWN, KC_RGHT, KC_RSFT},
 ...
 * |      |      |      |      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      | Prev | Play | Next |      |      | Esc  |   7  |   8  |   9  |   -  |   /  |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      | Vol- | Mute | Vol+ |      | Calc |      |   4  |   5  |   6  |   +  |   *  |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      |      | Float|      |      |      |   1  |   2  |   3  |   :  |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |   0  |   ,  |   .  |      |      |
...
[_NUMPAD] = {
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______},
  {_______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, KC_ESC,  KC_7,    KC_8,    KC_9,    KC_MINS, KC_SLSH},
  {_______, KC_VOLD, KC_MUTE, KC_VOLU, _______, KC_CALC, _______, KC_4,    KC_5,    KC_6,    KC_PLUS, KC_ASTR},
  {_______, _______, _______, M_FLOAT, _______, _______, _______, KC_1,    KC_2,    KC_3,    KC_COLN, _______},
