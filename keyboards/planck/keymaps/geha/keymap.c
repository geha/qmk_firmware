...
[_LOWER] = {
  ...
  {_______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_4,    KC_5,    KC_6,    KC_COMM, KC_COLN},
  {_______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_1,    KC_2,    KC_3,    KC_DOT,  _______},
  {_______, _______, _______, _______, _______, KC_DEL,  _______, _______, KC_0,    KC_LALT, _______, _______}
},
...
/* Adjust (Lower + Raise)
 * ,-----------------------------------------------------------------------------------.
 * |      | Reset| Debug| Zelda| OneUp|      |      | Calc |      |PrntSc| Scrl |Pause |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 ...
 */
[_ADJUST] = {
  {_______, RESET,   DEBUG,   ZELDA,   ONE_UP,  _______, _______, KC_CALC, _______, KC_PSCR, KC_SLCK, KC_PAUS},
