...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT(
        ...
        _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, KC_CALC, _______, _______, KC_7,    KC_8,    KC_9,    _______, _______, KC_END, \
        _______, KC_VOLD, KC_MUTE, KC_VOLU, _______, _______, _______, _______, _______, KC_4,    KC_5,    KC_6,             _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, KC_1,    KC_2,    KC_3,    _______,          KC_PGUP, _______, \
        _______, _______, _______,                            _______,                            KC_0,    _______, KC_HOME, KC_PGDN, KC_END  \
    ),
    /*
    [X] = LAYOUT(
